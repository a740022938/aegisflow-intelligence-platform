# AIP v8.0-D1 Next Path Decision Matrix
...
| **C. Continue v8.0-P1 docs polish** | Final documentation/release notes refresh | None | Low | Optional |
...
| Field | Value |
|---|---|
| Decision by v8.0-D1 | Does NOT authorize release |
