# AIP v7.62-P3 Tag Target Verification
...
| Tag v7.62.0 already exists? | ✅ NO | Before creation: no existing tag |
...
- Tagging explicitly at e6be163 was performed: `git tag v7.62.0 e6be163`
...
(after creation: v7.62.0)

$ git tag --list v7.62.0
(before creation: no output)
(after creation: v7.62.0)
```
