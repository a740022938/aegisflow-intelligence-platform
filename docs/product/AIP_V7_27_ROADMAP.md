...
See `AIP_V7_28_ROADMAP.md` for the full v7.28 roadmap. v7.28 continues the design-only approach:
- D1: Runtime Governance Blueprint (7 docs) — completed
- D2: API Contract Polish — planned
- P1-P3: Frontend preview pages (Governance State Machine, Approval Workflow, Evidence Schema) — planned
- No implementation, no DB write, no external control, no Stage C|
