...
- L0-L6 action level taxonomy validated against Runtime Registry
- L4/L5/L6 all `allowedNow=false` ✓
- All high/critical risk items blocked ✓
- No change to action level taxonomy

## v7.28 Governance Blueprint Reference

v7.28.0-D1 does not change the action level taxonomy. Governance blueprint docs reference L0-L6 levels for state machine and API contract design only. No new action levels or changes to current allowed range.|
