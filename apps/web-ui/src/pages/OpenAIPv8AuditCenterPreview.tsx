    ...
    <div style={shellStyle}>
      <div style={panelStyle}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 8 }}>
          <div>
            <h1 style={{ margin: 0, fontSize: 26 }}>OpenAIP v8 Audit Center Preview</h1>
            <p style={{ marginTop: 4, color: '#93c5fd', fontSize: 14 }}>审计链与证据信任层</p>
          ...
          <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
            ...
            <span style={{ ...badgeStyle, background: '#ef4444', color: '#fff' }}>No audit DB write</span>
          </div>
        </div>
        ...
        <div style={{ marginTop: 16, padding: 10, border: '1px solid #374151', borderRadius: 8, background: 'rgba(0,0,0,0.3)', fontSize: 11, color: '#6b7280', textAlign: 'center' }}>
          OpenAIP v8 · Audit Center · Readonly preview · No audit DB writes · No approval mutation · Gate remains CLOSED · Stage C disabled
        </div>
