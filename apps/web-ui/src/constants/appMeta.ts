...
export const APP_META = {
  ...
  // Points to last actual GitHub Release (v7.3.0). Update after each real release.
  releaseUrl: 'https://github.com/a740022938/aegisflow-intelligence-platform/releases/tag/v7.3.0',
