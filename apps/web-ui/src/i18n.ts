...
export const translations = {
  zh: {
    ...
    nav: {
      ...
      openAipV8PolicyCapabilityCenter: '策略与能力中心',
      openAipV8AuditCenter: '审计中心',
    ...
    nav: {
      ...
      knowledge: 'Knowledge',
      output: 'Output',
      openAipV8: 'OpenAIP v8 Control Plane',
      // ── Nav items ──
      dashboard: 'Dashboard',
      ...
      openAipV8AgentCenter: 'Agent Center',
      openAipV8TaskCenter: 'Task Center',
      openAipV8ProviderManager: 'Provider Manager',
      openAipV8IntegrationCenter: 'Integration Center',
      openAipV8LocalAppsCenter: 'Local Apps Center',
      openAipV8MemoryKnowledgeCenter: 'Memory + Knowledge Center',
      openAipV8PolicyCapabilityCenter: 'Policy + Capability Center',
      openAipV8AuditCenter: 'Audit Center',
