...
export const PERMISSION_EVALUATION_RULES: PermissionEvaluationRule[] = [
  ...
  {
    id: 'pe-runtime-dry-run-contract-preview',
    targetKind: 'page',
    targetId: 'runtime-dry-run-contract-preview',
    ...
    requiredEvidence: ['validator_summary', 'registry_snapshot'],
    reason: 'Runtime Dry-run Contract Preview is readonly. Displays dry-run request/response/gate/evidence/audit/rollback contract. No backend endpoint, no API call, no DB write, no external control, no Stage C. Contract only — does not execute dry-run.',
    nextAction: 'Keep hidden direct. Do not add to sidebar. Do not implement backend endpoint.',
  },
  {
    id: 'pe-runtime-audit-store-contract-preview',
    targetKind: 'page',
    targetId: 'runtime-audit-store-contract-preview',
    ...
    blockingConditions: ['Readonly only', 'No backend endpoint', 'No API call', 'No DB write', 'No external control', 'Stage C disabled'],
    requiredEvidence: ['validator_summary', 'registry_snapshot'],
    reason: 'Runtime Audit Store Contract Preview is readonly. Displays audit event schema/retention/redaction/write policy contract. No backend endpoint, no API call, no DB write, no external control, no Stage C. Contract only — does not create store.',
    nextAction: 'Keep hidden direct. Do not add to sidebar. Do not implement backend endpoint.',
  },
  {
    id: 'pe-stage-c-preenable-review-preview',
    targetKind: 'page',
    targetId: 'stage-c-preenable-review-preview',
    ...
    blockingConditions: ['Readonly only', 'No backend endpoint', 'No API call', 'No DB write', 'No external control', 'Stage C disabled'],
    requiredEvidence: ['validator_summary', 'registry_snapshot'],
    reason: 'Stage C Pre-Enable Human Review Pack is readonly. Displays pre-enable requirements checklist across 11 review areas. Does NOT enable Stage C. Review only.',
    nextAction: 'Keep hidden direct. Do not add to sidebar. Do not enable Stage C.',
  },
];
