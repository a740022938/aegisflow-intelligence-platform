...
export const PERMISSION_EVALUATION_RULES: PermissionEvaluationRule[] = [
  ...
  {
    id: 'pe-governance-console-preview',
    targetKind: 'page',
    targetId: 'governance-console-preview',
    ...
    blockingConditions: ['Readonly only', 'No registry mutation', 'No execution', 'No DB write', 'No external control', 'Stage C disabled'],
    requiredEvidence: ['governance_console_registry_snapshot', 'validator_summary'],
    reason: 'Governance Console Preview is readonly. Aggregates registry data without mutating registries, executing actions, writing to DB, or controlling external tools.',
    nextAction: 'Keep readonly preview. Do not enable console executor or registry mutation.',
  },
  {
    id: 'pe-governance-console-risk-dashboard-preview',
    targetKind: 'page',
    targetId: 'governance-console-risk-dashboard-preview',
    ...
    uiSurface: 'hidden_route',
    allowedNow: true,
    gates: ['readonly_only', 'no_execution', 'no_db_write', 'no_external_control', 'stage_c_disabled'],
    blockingConditions: ['Readonly only', 'No risk execution', 'No DB write', 'No external control', 'Stage C disabled'],
    requiredEvidence: ['risk_registry_snapshot', 'validator_summary'],
    reason: 'Governance Console Risk Dashboard Preview is readonly. Aggregates risks from 6 sources without executing gates, writing to DB, or controlling external tools.',
    nextAction: 'Keep readonly preview. Do not enable risk execution or gate control.',
  },
  {
    id: 'pe-governance-console-decision-panel-preview',
    targetKind: 'page',
    targetId: 'governance-console-decision-panel-preview',
    ...
    blockingConditions: ['Readonly only', 'No decision execution', 'No DB write', 'No external control', 'Stage C disabled'],
    requiredEvidence: ['decision_registry_snapshot', 'validator_summary'],
    reason: 'Governance Console Decision Panel Preview is readonly. Displays 14 decision types without approving, rejecting, or executing actions.',
    nextAction: 'Keep readonly preview. Do not enable decision execution.',
  },
  {
    id: 'pe-governance-console-report-pack-preview',
    targetKind: 'page',
    targetId: 'governance-console-report-pack-preview',
    ...
    blockingConditions: ['Readonly only', 'No report export', 'No DB write', 'No external control', 'Stage C disabled'],
    requiredEvidence: ['report_pack_registry_snapshot', 'validator_summary'],
    reason: 'Governance Console Report Pack Preview is readonly. Defines 11 sections with fields and source registries without generating real files or storing reports.',
    nextAction: 'Keep readonly preview. Do not enable report export or store.',
  },
  {
    id: 'pe-db-write',
    targetKind: 'action',
