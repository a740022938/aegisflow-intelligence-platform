...
export const OPERATOR_MEMORY_BRIDGE_REGISTRY: MemoryBridgeItem[] = [
  {
    ...
    versionRange: 'v7.43',
    readonly: true,
    summary: 'v7.43 D1 committed at 816f376. Working tree clean. Stage C disabled.',
    operatorNote: 'Use git log and git status to verify current baseline before any phase.',
  },
  {
    id: 'mem-v7.25-v7.40',
