...
export const MEMORY_KNOWLEDGE_REGISTRY: MemoryKnowledgeEntry[] = [
  ...
  { key: 'releaseTag', value: 'v8.0.0', confidence: 'verified', source: 'v8.0-P3 tag creation at e6be163', updatedAt: '2026-05-22' },
  { key: 'releaseCommit', value: 'e6be163', confidence: 'verified', source: 'v8.0-P2 pre-tag verification + P3 tag', updatedAt: '2026-05-22' },
  { key: 'releaseFinalHead', value: '451f8d0', confidence: 'verified', source: 'v8.0-P5 final seal commit', updatedAt: '2026-05-22' },
  { key: 'releaseUrl', value: 'https://github.com/a740022938/aegisflow-intelligence-platform/releases/tag/v8.0.0', confidence: 'verified', source: 'v8.0-P4 GitHub Release creation', updatedAt: '2026-05-22' },
  { key: 'releaseStatus', value: 'published', confidence: 'verified', source: 'v8.0-P4 GitHub Release + notes published', updatedAt: '2026-05-22' },
  { key: 'postReleaseNext', value: 'v7.63 maintenance/cleanup — address dirty concurrent work (ModelGateway/superpowers)', confidence: 'verified', source: 'v8.0-P5 next maintenance recommendation', updatedAt: '2026-05-22' },
];
