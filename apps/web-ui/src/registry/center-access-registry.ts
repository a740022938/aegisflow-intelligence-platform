...
export const CENTER_ACCESS_REGISTRY: CenterAccessItem[] = [
  ...
  },
  {
    ...
    allowedActions: ['view_contract_catalog', 'view_schema_board', 'view_mock_responses', 'view_gate_model', 'view_error_model', 'view_validator_summary'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'implement_endpoint', 'deploy_mock_server', 'call_external_api', 'release'],
