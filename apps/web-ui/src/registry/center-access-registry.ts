...
export const CENTER_ACCESS_REGISTRY: CenterAccessItem[] = [
  ...
  },
  {
    ...
    name: 'Stage C Readiness Dashboard Preview',
    kind: 'governance',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_execute', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_readiness_dashboard', 'view_contract_terms'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'contract_frozen'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_readiness'],
    description: 'Stage C Readiness Dashboard Preview — v7.34.0-P1 readonly readiness overview. 24 contract terms, 4 validators, 9 smoke tests, 6 safety boundaries. 未入左侧菜单。hidden direct route。',
    notes: 'Stage C Readiness Dashboard Preview — P1 readiness dashboard。24 contract terms, 4 validators。不入 sidebar。不启用 Stage C。无 enable 按钮。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Readiness Dashboard Preview — P1 readonly dashboard. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly Stage C readiness dashboard. Shows contract terms, validators, smoke, safety boundaries. No enable action, no mutation, no POST.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-human-approval-review-preview',
    name: 'Stage C Human Approval Review Preview',
    kind: 'governance',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_execute', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_human_approval_review'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'registry_complete'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_human_approval'],
    description: 'Stage C Human Approval Review Preview — v7.34.0-P2 readonly human approval review. 22 review items, 18 validator checks. No approve/deny capability. No enable button. 未入左侧菜单。hidden direct route。',
    notes: 'Stage C Human Approval Review Preview — P2 readonly review。22 items, 18 checks。不入 sidebar。不启用 Stage C。无 approve/deny。无 enable 按钮。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Human Approval Review Preview — P2 readonly review. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly human approval review. Shows role boundaries, approval gates, denial policy, evidence requirements. No approve/deny, no enable action, no mutation.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-evidence-readiness-drill-preview',
    name: 'Stage C Evidence Readiness Drill Preview',
    kind: 'governance',
    ...
    visibleInSidebar: false,
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_evidence_write', 'no_upload', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_evidence_readiness_drill'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'collect_evidence', 'upload_file', 'write_evidence_store', 'write_audit_store', 'release'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_evidence_write', 'no_upload', 'validator_pass', 'registry_complete'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_evidence'],
    description: 'Stage C Evidence Readiness Drill Preview — v7.34.0-P3 readonly evidence readiness. 24 evidence items, 20 validator checks. No evidence write/store. No upload. 未入左侧菜单。hidden direct route。',
    notes: 'Stage C Evidence Readiness Drill Preview — P3 readonly drill。24 evidence items, 20 checks。不入 sidebar。不启用 Stage C。不写 evidence store。不上传。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Evidence Readiness Drill Preview — P3 readonly drill. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly evidence readiness drill. Shows evidence chain, source-of-truth, missing/deferred items. No evidence write, no upload, no enable action.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-preenable-seal-candidate-preview',
    name: 'Stage C Pre-Enable Seal Candidate Preview',
    kind: 'governance',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_execute', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_preenable_seal_candidate'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store', 'tag_release'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'seal_candidate_complete'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_seal_candidate'],
    description: 'Stage C Pre-Enable Seal Candidate Preview — v7.34.0-P4 readonly seal candidate. 29 seal items, 18 validator checks. Stage C still disabled. Not an enablement page. 未入左侧菜单。hidden direct route。',
    notes: 'Stage C Pre-Enable Seal Candidate Preview — P4 readonly seal candidate。29 items, 18 checks。不入 sidebar。不启用 Stage C。无 enable 按钮。不是启用。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Pre-Enable Seal Candidate Preview — P4 readonly seal candidate. Keep hidden direct. Not in sidebar. Stage C remains disabled. Not a final enablement.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly pre-enable seal candidate. Shows 29 seal items across 12 areas, human approval gates, evidence readiness, safety boundaries. No enable action, no mutation, no POST.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-authorization-review-console-preview',
    name: 'Stage C Authorization Review Console Preview',
    kind: 'governance',
    ...
    visibleInSidebar: false,
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_authorize', 'no_execute', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_authorization_review'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'authorize', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store', 'auto_approve_authorization'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'contract_frozen'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_authorization'],
    description: 'Stage C Authorization Review Console Preview — v7.35.0-P1 readonly authorization review. 28 contract items, 19 validator checks. No authorize/enable capability. Stage C remains disabled. 未入左侧菜单。hidden direct route。',
    notes: 'Stage C Authorization Review Console Preview — P1 readonly review。28 items, 19 checks。不入 sidebar。不启用 Stage C。无 authorize/enable。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Authorization Review Console Preview — P1 readonly review. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly authorization review console. Shows 28 contract items, blocker checklist, evidence requirements, forbidden automation. No authorize/enable capability, no mutation.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-authorization-artifact-review-preview',
    name: 'Stage C Authorization Artifact Review Preview',
    kind: 'governance',
    route: '/stage-c-authorization-artifact-review-preview',
    status: 'hidden_direct',
    risk: 'low',
    readiness: 'ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_authorize', 'no_execute', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_artifact_review'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'authorize', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store', 'auto_approve_authorization'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'artifact_review_done'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_artifact_review'],
    description: 'Stage C Authorization Artifact Review Preview — v7.35.0-P2 readonly artifact review. 32 items, 18 validator checks. Authorization state: PENDING. No authorize/enable capability. Stage C remains disabled.',
    notes: 'Stage C Authorization Artifact Review Preview — P2 readonly review. 32 items, 8 categories. AUTHORIZATION_PENDING. 不入 sidebar。不启用 Stage C。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Authorization Artifact Review Preview — P2 readonly artifact review. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly artifact review. Shows 32 items across 8 categories. Authorization state: PENDING. No authorize/enable capability.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-enablement-planning-preview',
    name: 'Stage C Enablement Planning Preview',
    kind: 'governance',
    route: '/stage-c-enablement-planning-preview',
    status: 'hidden_direct',
    risk: 'low',
    readiness: 'ready',
    exposureRecommendation: 'keep_hidden_direct',
    visibleInSidebar: false,
    allowedNow: true,
    safetyBoundary: ['readonly', 'planning_only', 'no_implementation', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_planning_preview'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'authorize', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'implement_enablement', 'write_evidence_store', 'write_audit_store'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'planning_only'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 85,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_planning'],
    description: 'Stage C Enablement Planning Preview — v7.35.0-P3 readonly planning preview. 33 items, 16 validator checks. Planning only, no implementation. Stage C remains disabled.',
    notes: 'Stage C Enablement Planning Preview — P3 planning only. 33 items, 9 categories. 不入 sidebar。不实施。不启用 Stage C。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Enablement Planning Preview — P3 readonly planning preview. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly planning preview. Shows 33 items across 9 categories. No implementation, no enablement.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-authorization-gate-seal-preview',
    name: 'Stage C Authorization Gate Seal Preview',
    kind: 'governance',
    route: '/stage-c-authorization-gate-seal-preview',
    status: 'hidden_direct',
    risk: 'low',
    readiness: 'ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_authorize', 'no_execute', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_gate_seal'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'authorize', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store', 'auto_approve_authorization'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'gate_seal_done'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_gate_seal'],
    description: 'Stage C Authorization Gate Seal Preview — v7.35.0-P4 readonly gate seal candidate. 42 items, 18 validator checks. Authorization state: PENDING. Stage C remains disabled.',
    notes: 'Stage C Authorization Gate Seal Preview — P4 gate seal candidate. 42 items, 8 categories. AUTHORIZATION_PENDING. 不入 sidebar。不启用 Stage C。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Authorization Gate Seal Preview — P4 readonly gate seal candidate. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly gate seal candidate. Shows 42 items across 8 categories. Authorization state: PENDING. No enablement.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-enablement-simulation-console-preview',
    name: 'Stage C Enablement Simulation Console Preview',
    kind: 'governance',
    ...
    visibleInSidebar: false,
    allowedNow: true,
    safetyBoundary: ['readonly', 'simulation_only', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_simulation'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'authorize', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'simulate_enablement', 'write_evidence_store', 'write_audit_store', 'auto_approve_authorization'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass', 'simulation_only'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 85,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_simulation'],
    description: 'Stage C Enablement Simulation Console Preview — v7.36.0-P1 readonly simulation. 43 harness items, 24 validator checks. Simulation only, not executed. Authorization PENDING. Stage C remains disabled.',
    notes: 'Stage C Enablement Simulation Console Preview — P1 readonly simulation. 43 items, 10 categories. Simulation NOT EXECUTED. 不入 sidebar。不执行 enablement。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Enablement Simulation Console Preview — P1 readonly simulation. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly simulation preview. Shows 43 harness items across 10 gates. Simulation NOT EXECUTED. No enablement.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
    id: 'stage-c-minimal-first-slice-v7-39-preview',
    name: 'Stage C Minimal First Slice Preview (v7.39)',
    kind: 'governance',
    ...
    visibleInSidebar: false,
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_implementation_pack'],
    blockedActions: ['enable_stage_c', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'authorize', 'approve', 'deny', 'release', 'execute_rollback', 'execute_restart', 'write_evidence_store', 'write_audit_store', 'auto_approve_authorization'],
    requiredBeforeExposure: ['readonly_only', 'no_post', 'no_db_write', 'no_external_control', 'validator_pass'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    sidebarState: 'hidden_direct',
    ...
    readinessScore: 85,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_first_slice'],
    description: 'Stage C Minimal First Slice Preview — v7.39. 22 registry items, 9 categories, 13 validator checks. Authorization GRANTED for review. Stage C remains disabled.',
    notes: 'Stage C Minimal First Slice Preview — v7.39. 22 items, 9 categories. 不入 sidebar。不执行 enablement。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C Minimal First Slice Preview — v7.39. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly minimal first slice preview. Shows 22 items across 9 categories. Stage C disabled. No enablement.',
    maturity: 'preview',
    owner: 'governance',
  },
  {
  ...
  },
  {
    ...
    name: 'Stage C Feature Flag Toggle Trial Preview',
    kind: 'governance',
    route: '/stage-c-feature-flag-toggle-trial-preview',
    status: 'hidden_direct',
    risk: 'medium',
    readiness: 'preview_ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_toggle', 'no_mutation', 'no_db_write', 'no_external_control', 'no_stage_c'],
    allowedActions: ['view_trial_preview', 'view_trial_plan', 'view_requirements'],
    blockedActions: ['enable_stage_c', 'toggle_feature_flag', 'write_database', 'modify_sidebar', 'control_external_tools', 'call_external_api', 'release', 'approve', 'reject'],
    requiredBeforeExposure: ['readonly_only', 'no_toggle', 'no_db_write', 'validator_pass'],
    releaseGate: [],
    displayOrder: 999,
    ...
    readinessScore: 90,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '试切换计划只读预览', 'toggle_not_executed'],
    description: 'Stage C Feature Flag Toggle Trial Preview — 21 项试切换注册表条目。toggleExecuted=false。未入左侧菜单。hidden direct route。',
    notes: 'v7.40-P2 Feature Flag Toggle Trial Preview。21 items。全部 readonly/trialPlanOnly/toggleExecuted=false。不入 sidebar。不启用 Stage C。不写 DB。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'v7.40-P2 Feature Flag Toggle Trial Preview — readonly trial plan preview. Keep hidden direct. Not in sidebar. Toggle not executed.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
