...
export const CENTER_ACCESS_REGISTRY: CenterAccessItem[] = [
  ...
  },
  {
    ...
    name: 'Operator End-to-End Flow Preview',
    kind: 'operator_readiness',
    route: '/operator-end-to-end-flow-preview',
    status: 'hidden_direct',
    risk: 'medium',
    readiness: 'preview_ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    readinessScore: 85,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '端到端操作员流程只读预览', 'stage_c_disabled'],
    description: 'Operator End-to-End Flow Preview — v7.44. 10步流程串联 CLI 到 Web 总控台。未入左侧菜单。hidden direct route。',
    notes: 'v7.44-P1 Operator End-to-End Flow Preview。10 steps，全部 readonly。不入 sidebar。不启用 Stage C。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'v7.44-P1 Operator End-to-End Flow Preview — readonly e2e flow. Keep hidden direct. Not in sidebar. Stage C disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly end-to-end flow preview. No enablement, no mutation, no POST.',
    maturity: 'preview',
    owner: 'operator',
  },
  {
    id: 'operator-usability-drill-preview',
    name: 'Operator Usability Drill Preview',
    kind: 'operator_readiness',
    route: '/operator-usability-drill-preview',
    status: 'hidden_direct',
    risk: 'medium',
    readiness: 'preview_ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_stage_c', 'no_db_write', 'no_external_control', 'no_post_runtime', 'no_executor', 'no_connector_action'],
    allowedActions: ['view_usability_drill'],
    blockedActions: ['enable_stage_c', 'toggle_feature_flag', 'write_database', 'modify_sidebar', 'control_external_tools', 'execute_runtime', 'connector_action', 'restart_service', 'create_tag', 'create_release', 'execute_repair', 'accept_authorization'],
    requiredBeforeExposure: ['readonly_only', 'no_stage_c', 'no_db_write', 'validator_pass'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    ...
    readinessScore: 85,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '可用性测试只读预览', 'stage_c_disabled'],
    description: 'Operator Usability Drill Preview — v7.44. 5 drill scenarios: repair, memory, auth, decision, receipt. 未入左侧菜单。hidden direct route。',
    notes: 'v7.44-P3 Operator Usability Drill Preview。5 scenarios，全部 readonly。不入 sidebar。不启用 Stage C。不执行修复。不接受授权。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'v7.44-P3 Operator Usability Drill Preview — readonly usability drill. Keep hidden direct. Not in sidebar. Stage C disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly usability drill preview. No repair execution, no memory mutation, no authorization accepted.',
    maturity: 'preview',
    owner: 'operator',
  },
  {
    id: 'restore-point-pack-preview',
    name: 'Restore Point Pack Preview',
    kind: 'operator_readiness',
    route: '/restore-point-pack-preview',
    status: 'hidden_direct',
    risk: 'medium',
    readiness: 'preview_ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_stage_c', 'no_db_write', 'no_external_control', 'no_post_runtime', 'no_executor', 'no_connector_action'],
    allowedActions: ['view_restore_point_pack'],
    blockedActions: ['enable_stage_c', 'toggle_feature_flag', 'write_database', 'modify_sidebar', 'control_external_tools', 'execute_runtime', 'connector_action', 'restart_service', 'create_tag', 'create_release', 'execute_restore', 'capture_secrets'],
    requiredBeforeExposure: ['readonly_only', 'no_stage_c', 'no_db_write', 'validator_pass'],
    releaseGate: [],
    displayOrder: 999,
    group: 'governance',
    ...
    readinessScore: 80,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '恢复点包只读预览', 'stage_c_disabled'],
    description: 'Restore Point Pack Preview — v7.45. 10 items: design/policy/safety. 未入左侧菜单。hidden direct route。Plan-only。',
    notes: 'v7.45-P2 Restore Point Pack Preview。10 items，全部 readonly。不执行 restore。不捕获 secrets。不入 sidebar。不启用 Stage C。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'v7.45-P2 Restore Point Pack Preview — plan-only restore point design. Keep hidden direct. Not in sidebar. Stage C disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — plan-only restore point pack preview. No file restore, no secret capture.',
    maturity: 'preview',
    owner: 'operator',
  },
  {
    id: 'handoff-pack-preview',
    name: 'Handoff Pack Preview',
    kind: 'operator_readiness',
    route: '/handoff-pack-preview',
    status: 'hidden_direct',
    risk: 'medium',
    readiness: 'preview_ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    allowedNow: true,
    safetyBoundary: ['readonly', 'no_stage_c', 'no_db_write', 'no_external_control', 'no_post_runtime', 'no_executor', 'no_connector_action'],
    allowedActions: ['view_handoff_pack', 'view_release_evidence'],
    blockedActions: ['enable_stage_c', 'toggle_feature_flag', 'write_database', 'modify_sidebar', 'control_external_tools', 'execute_runtime', 'connector_action', 'restart_service', 'create_tag', 'create_release', 'execute_restore', 'capture_secrets'],
    requiredBeforeExposure: ['readonly_only', 'no_stage_c', 'no_db_write', 'validator_pass'],
    releaseGate: [],
    displayOrder: 999,
    ...
    readinessScore: 80,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', 'handoff包只读预览', 'stage_c_disabled'],
    description: 'Handoff Pack Preview — v7.45. Release evidence matrix + handoff pack registry + checker. 未入左侧菜单。hidden direct route。Plan-only。',
    notes: 'v7.45-P4 Handoff Pack Preview。释放证据矩阵 + handoff registry + checker。全部 readonly。不执行 restore。不捕获 secrets。不入 sidebar。不启用 Stage C。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'v7.45-P4 Handoff Pack Preview — release evidence matrix + handoff pack. Keep hidden direct. Not in sidebar. Stage C disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — plan-only handoff pack preview. No file restore, no secret capture.',
    maturity: 'preview',
    owner: 'operator',
  },
];
