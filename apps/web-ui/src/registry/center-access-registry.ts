...
export const CENTER_ACCESS_REGISTRY: CenterAccessItem[] = [
  ...
  },
  {
    ...
    name: 'Stage C First Slice Implementation Preview',
    kind: 'governance',
    route: '/stage-c-first-slice-implementation-preview',
    status: 'hidden_direct',
    risk: 'low',
    readiness: 'ready',
    exposureRecommendation: 'keep_hidden_direct',
    ...
    readinessScore: 85,
    qualityGate: { readonly: true, noDbWrite: true, noExternalControl: true, noStageC: true, noDangerousActions: true },
    statusBadges: ['未入菜单', '当前可开放', 'stage_c_implementation_pack'],
    description: 'Stage C First Slice Implementation Preview — v7.38.0-D1 readonly implementation pack preview. 15 items, 5 categories, 6 validator checks. Authorization PENDING. Stage C remains disabled.',
    notes: 'Stage C First Slice Implementation Preview — D1 implementation pack. 15 items, 5 categories. 不入 sidebar。不执行 enablement。',
    accessLevel: 'direct_url_only',
    recommendedAccessLevel: 'direct_url_only',
    launchpadVisible: true,
    advancedHubVisible: true,
    ...
    exposureStage: 'design',
    exposureDecision: 'hold',
    exposureReason: 'Stage C First Slice Implementation Preview — D1 implementation pack. Keep hidden direct. Not in sidebar. Stage C remains disabled.',
    targetContainer: 'launchpad',
    rollbackPlan: 'No sidebar entry to revert. Remove route from App.tsx if needed.',
    userImpact: 'Low — readonly implementation pack preview. Shows 15 items across 5 categories. Authorization PENDING. No enablement.',
    maturity: 'preview',
    owner: 'governance',
  },
];
