...
export const OPERATOR_RUNTIME_READINESS_REGISTRY: OperatorRuntimeReadinessItem[] = [
  // ── System ──
  {
    ...
    evidence: 'HEAD at 816f376 (v7.43 D1), working tree clean',
    allowedNow: true,
    requiresHumanApproval: false,
    readonly: true,
    summary: 'v7.43 D1 commit sealed. Main branch, working tree clean.',
  ...
  },
  {
    ...
    evidence: 'Working tree clean at HEAD 816f376',
    allowedNow: true,
    requiresHumanApproval: false,
    readonly: true,
