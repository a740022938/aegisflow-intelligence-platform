...
export const V8_AGENTS: V8AgentEntry[] = [
  ...
  },
  {
    ...
    lifecycle: 'disabled', permissionLevel: 'L0', status: 'disabled',
    configured: false, online: false, authorized: false, gateOpen: false, stageCEnabled: false,
    dataSource: 'static_registry', risk: 'low',
    safetyNote: 'No operations available.',
    blockedActions: ['all agent operations'],
    capabilities: [],
...
export const V8_LOCAL_APPS: V8LocalAppEntry[] = [
  ...
  { id: 'app.future-local-placeholder', name: 'Future Local App', kind: 'local_app', category: 'unknown_local_app', lifecycle: 'disabled', configuredState: 'unconfigured', installedState: 'not_installed', runningState: 'stopped', launchState: 'blocked', connectionMode: 'planned', relatedProviderId: null, relatedIntegrationId: null, relatedCapabilityIds: [], risk: 'low', permissionLevel: 'L0', permissionRequired: 'L0', configured: false, online: false, authorized: false, gateOpen: false, stageCEnabled: false, allowedInPreview: false, readonly: true, dataSource: 'future_integration', safetyNote: 'Disabled.', blockedActions: ['all local app operations'] },
];
